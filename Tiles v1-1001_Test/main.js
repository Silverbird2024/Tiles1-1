...
$App.NAB={PageList:["Home","Homestuff","Workstuff","Templates","Template001","Template1setup"],PageEnterEffect:["","","","","",""],PageCount:6,PageExitEffect:["","","","","",""],PageNumber:1,AppScale:1,PageID:"",Hour:"",Hour24:"",Minute:"",Second:"",Time:"",Time24:"",DateShort:"",DateLong:"",DateFull:"",Month:"",MonthNum:"",WeekNum:"",Day:"",DayNum:"",Year:"",ClientWidth:$window.innerWidth,ClientHeight:$window.innerHeight,WindowWidth:$window.outerWidth,WindowHeight:$window.outerHeight,Orientation:$scope.GetOrientation(),OperatingSystem:"",$Watches:{},$Timers:{},$Audio:{}};$scope.__doUpdate=function(){var Now=new Date();$App.NAB.Hour=$filter("date")(Now,"h");$App.NAB.Hour24=$filter("date")(Now,"H");$App.NAB.Minute=$filter("date")(Now,"mm");$App.NAB.Second=$filter("date")(Now,"ss");$App.NAB.Time=$filter("date")(Now,"mediumTime");$App.NAB.Time24=$filter("date")(Now,"H:mm:ss");$App.NAB.DateShort=$filter("date")(Now,"shortDate");$App.NAB.DateLong=$filter("date")(Now,"longDate");$App.NAB.DateFull=$filter("date")(Now,"fullDate");$App.NAB.Month=$filter("date")(Now,"MMMM");$App.NAB.MonthNum=$filter("date")(Now,"M");$App.NAB.WeekNum=$filter("date")(Now,"w");$App.NAB.Day=$filter("date")(Now,"EEEE");$App.NAB.DayNum=$filter("date")(Now,"d");$App.NAB.Year=$filter("date")(Now,"yyyy");};$scope.__doOrientationChange=function(){$App.NAB.Orientation=$scope.GetOrientation();};$scope.__doResize=function(){$App.NAB.ClientWidth=$window.innerWidth;$App.NAB.ClientHeight=$window.innerHeight;$App.NAB.WindowWidth=$window.outerWidth;$App.NAB.WindowHeight=$window.outerHeight;var o=$scope.GetOrientation();if(o!=$App.NAB.Orientation){$scope.__doOrientationChange();};};$scope.__init=function(){angular.element($window).bind("orientationchange.app",function(){$timeout($scope.__doOrientationChange);});angular.element($window).bind("resize.app",function(){$timeout($scope.__doResize);});$interval($scope.__doUpdate,1000);$App.NAB.OperatingSystem=GetPlatform();$scope.__doUpdate();};
$scope.Home_pageenter = function() {debugScriptBegin( 2630,"Home","pageenter",3 );
debugScriptRun( 2630,"GetItem \"title001\" [title001]",0 );
$App.title001 = localStorage.getItem("title001");
debugScriptRun( 2630,"GetItem \"title002\" [title002]",1 );
$App.title002 = localStorage.getItem("title002");
debugScriptRun( 2630,"GetItem \"title003\" [title003]",2 );
$App.title003 = localStorage.getItem("title003");
debugScriptRun( 2630,"GetItem \"title004\" [title004]",3 );
$App.title004 = localStorage.getItem("title004");
debugScriptRun( 2630,"GetItem \"title001n\" [title001n]",5 );
$App.title001n = localStorage.getItem("title001n");
debugScriptRun( 2630,"GetItem \"title002n\" [title002n]",6 );
$App.title002n = localStorage.getItem("title002n");
debugScriptRun( 2630,"GetItem \"title003n\" [title003n]",7 );
$App.title003n = localStorage.getItem("title003n");
debugScriptRun( 2630,"GetItem \"title004n\" [title004n]",8 );
$App.title004n = localStorage.getItem("title004n");
debugScriptRun( 2630,"GetItem \"title005\" [title005]",10 );
$App.title005 = localStorage.getItem("title005");
debugScriptRun( 2630,"GetItem \"title006\" [title006]",11 );
$App.title006 = localStorage.getItem("title006");
debugScriptRun( 2630,"GetItem \"title007\" [title007]",12 );
$App.title007 = localStorage.getItem("title007");
debugScriptRun( 2630,"GetItem \"title008\" [title008]",13 );
$App.title008 = localStorage.getItem("title008");
debugScriptRun( 2630,"GetItem \"title005n\" [title005n]",15 );
$App.title005n = localStorage.getItem("title005n");
debugScriptRun( 2630,"GetItem \"title006n\" [title006n]",16 );
$App.title006n = localStorage.getItem("title006n");
debugScriptRun( 2630,"GetItem \"title007n\" [title007n]",17 );
$App.title007n = localStorage.getItem("title007n");
debugScriptRun( 2630,"GetItem \"title008n\" [title008n]",18 );
$App.title008n = localStorage.getItem("title008n");
debugScriptRun( 2630,"GetItem \"title009\" [title009]",20 );
$App.title009 = localStorage.getItem("title009");
debugScriptRun( 2630,"GetItem \"title010\" [title010]",21 );
$App.title010 = localStorage.getItem("title010");
debugScriptRun( 2630,"GetItem \"title011\" [title011]",22 );
$App.title011 = localStorage.getItem("title011");
debugScriptRun( 2630,"GetItem \"title012\" [title012]",23 );
$App.title012 = localStorage.getItem("title012");
debugScriptRun( 2630,"GetItem \"title009n\" [title009n]",25 );
$App.title009n = localStorage.getItem("title009n");
debugScriptRun( 2630,"GetItem \"title010n\" [title010n]",26 );
$App.title010n = localStorage.getItem("title010n");
debugScriptRun( 2630,"GetItem \"title011n\" [title011n]",27 );
$App.title011n = localStorage.getItem("title011n");
debugScriptRun( 2630,"GetItem \"title012n\" [title012n]",28 );
$App.title012n = localStorage.getItem("title012n");
debugScriptRun( 2630,"GetItem \"title013\" [title005]",30 );
$App.title005 = localStorage.getItem("title013");
debugScriptRun( 2630,"GetItem \"title014\" [title006]",31 );
$App.title006 = localStorage.getItem("title014");
debugScriptRun( 2630,"GetItem \"title015\" [title007]",32 );
$App.title007 = localStorage.getItem("title015");
debugScriptRun( 2630,"GetItem \"title016\" [title008]",33 );
$App.title008 = localStorage.getItem("title016");
debugScriptRun( 2630,"GetItem \"title013n\" [title013n]",35 );
$App.title013n = localStorage.getItem("title013n");
debugScriptRun( 2630,"GetItem \"title014n\" [title014n]",36 );
$App.title014n = localStorage.getItem("title014n");
debugScriptRun( 2630,"GetItem \"title015n\" [title015n]",37 );
$App.title015n = localStorage.getItem("title015n");
debugScriptRun( 2630,"GetItem \"title016n\" [title016n]",38 );
$App.title016n = localStorage.getItem("title016n");
debugScriptRun( 2630,"GetItem \"1title001\" [1title001]",40 );
$App.1title001 = localStorage.getItem("1title001");
debugScriptRun( 2630,"GetItem \"1title002\" [1title002]",41 );
$App.1title002 = localStorage.getItem("1title002");
debugScriptRun( 2630,"GetItem \"1title003\" [1title003]",42 );
$App.1title003 = localStorage.getItem("1title003");
debugScriptRun( 2630,"GetItem \"1title004\" [1title004]",43 );
$App.1title004 = localStorage.getItem("1title004");
debugScriptRun( 2630,"GetItem \"1title001n\" [1title001n]",45 );
$App.1title001n = localStorage.getItem("1title001n");
debugScriptRun( 2630,"GetItem \"1title002n\" [1title002n]",46 );
$App.1title002n = localStorage.getItem("1title002n");
debugScriptRun( 2630,"GetItem \"1title003n\" [1title003n]",47 );
$App.1title003n = localStorage.getItem("1title003n");
debugScriptRun( 2630,"GetItem \"1title004n\" [1title004n]",48 );
$App.1title004n = localStorage.getItem("1title004n");
debugScriptRun( 2630,"GetItem \"1title005\" [1title005]",50 );
$App.1title005 = localStorage.getItem("1title005");
debugScriptRun( 2630,"GetItem \"1title006\" [1title006]",51 );
$App.1title006 = localStorage.getItem("1title006");
debugScriptRun( 2630,"GetItem \"1title007\" [1title007]",52 );
$App.1title007 = localStorage.getItem("1title007");
debugScriptRun( 2630,"GetItem \"1title008\" [1title008]",53 );
$App.1title008 = localStorage.getItem("1title008");
debugScriptRun( 2630,"GetItem \"1title005n\" [1title005n]",55 );
$App.1title005n = localStorage.getItem("1title005n");
debugScriptRun( 2630,"GetItem \"1title006n\" [1title006n]",56 );
$App.1title006n = localStorage.getItem("1title006n");
debugScriptRun( 2630,"GetItem \"1title007n\" [1title007n]",57 );
$App.1title007n = localStorage.getItem("1title007n");
debugScriptRun( 2630,"GetItem \"1title008n\" [1title008n]",58 );
$App.1title008n = localStorage.getItem("1title008n");
debugScriptRun( 2630,"GetItem \"1title009\" [1title009]",60 );
$App.1title009 = localStorage.getItem("1title009");
debugScriptRun( 2630,"GetItem \"1title010\" [1title010]",61 );
$App.1title010 = localStorage.getItem("1title010");
debugScriptRun( 2630,"GetItem \"1title011\" [1title011]",62 );
$App.1title011 = localStorage.getItem("1title011");
debugScriptRun( 2630,"GetItem \"1title012\" [1title012]",63 );
$App.1title012 = localStorage.getItem("1title012");
debugScriptRun( 2630,"GetItem \"1title009n\" [1title009n]",65 );
$App.1title009n = localStorage.getItem("1title009n");
debugScriptRun( 2630,"GetItem \"1title010n\" [1title010n]",66 );
$App.1title010n = localStorage.getItem("1title010n");
debugScriptRun( 2630,"GetItem \"1title011n\" [1title011n]",67 );
$App.1title011n = localStorage.getItem("1title011n");
debugScriptRun( 2630,"GetItem \"1title012n\" [1title012n]",68 );
$App.1title012n = localStorage.getItem("1title012n");
debugScriptRun( 2630,"GetItem \"1title013\" [1title005]",70 );
$App.1title005 = localStorage.getItem("1title013");
debugScriptRun( 2630,"GetItem \"1title014\" [1title006]",71 );
$App.1title006 = localStorage.getItem("1title014");
debugScriptRun( 2630,"GetItem \"1title015\" [1title007]",72 );
$App.1title007 = localStorage.getItem("1title015");
debugScriptRun( 2630,"GetItem \"1title016\" [1title008]",73 );
$App.1title008 = localStorage.getItem("1title016");
debugScriptRun( 2630,"GetItem \"1title013n\" [1title013n]",75 );
$App.1title013n = localStorage.getItem("1title013n");
debugScriptRun( 2630,"GetItem \"1title014n\" [1title014n]",76 );
$App.1title014n = localStorage.getItem("1title014n");
debugScriptRun( 2630,"GetItem \"1title015n\" [1title015n]",77 );
$App.1title015n = localStorage.getItem("1title015n");
debugScriptRun( 2630,"GetItem \"1title016n\" [1title016n]",78 );
$App.1title016n = localStorage.getItem("1title016n");
debugScriptRun( 2630,"GetItem \"main001n\" [main001n]",82 );
$App.main001n = localStorage.getItem("main001n");
debugScriptRun( 2630,"GetItem \"main002n\" [main002n]",83 );
$App.main002n = localStorage.getItem("main002n");
debugScriptRun( 2630,"GetItem \"main003n\" [main003n]",84 );
$App.main003n = localStorage.getItem("main003n");
debugScriptRun( 2630,"GetItem \"main004n\" [main004n]",85 );
$App.main004n = localStorage.getItem("main004n");
debugScriptEnd( 2630 );};
$scope.Homestuff_pageenter = function() {debugScriptBegin( 2631,"Homestuff","pageenter",3 );
debugScriptRun( 2631,"GetItem \"title001\" [title001]",0 );
$App.title001 = localStorage.getItem("title001");
debugScriptRun( 2631,"GetItem \"title002\" [title002]",1 );
$App.title002 = localStorage.getItem("title002");
debugScriptRun( 2631,"GetItem \"title003\" [title003]",2 );
$App.title003 = localStorage.getItem("title003");
debugScriptRun( 2631,"GetItem \"title004\" [title004]",3 );
$App.title004 = localStorage.getItem("title004");
debugScriptRun( 2631,"GetItem \"title001n\" [title001n]",5 );
$App.title001n = localStorage.getItem("title001n");
debugScriptRun( 2631,"GetItem \"title002n\" [title002n]",6 );
$App.title002n = localStorage.getItem("title002n");
debugScriptRun( 2631,"GetItem \"title003n\" [title003n]",7 );
$App.title003n = localStorage.getItem("title003n");
debugScriptRun( 2631,"GetItem \"title004n\" [title004n]",8 );
$App.title004n = localStorage.getItem("title004n");
debugScriptRun( 2631,"GetItem \"title005\" [title005]",10 );
$App.title005 = localStorage.getItem("title005");
debugScriptRun( 2631,"GetItem \"title006\" [title006]",11 );
$App.title006 = localStorage.getItem("title006");
debugScriptRun( 2631,"GetItem \"title007\" [title007]",12 );
$App.title007 = localStorage.getItem("title007");
debugScriptRun( 2631,"GetItem \"title008\" [title008]",13 );
$App.title008 = localStorage.getItem("title008");
debugScriptRun( 2631,"GetItem \"title005n\" [title005n]",15 );
$App.title005n = localStorage.getItem("title005n");
debugScriptRun( 2631,"GetItem \"title006n\" [title006n]",16 );
$App.title006n = localStorage.getItem("title006n");
debugScriptRun( 2631,"GetItem \"title007n\" [title007n]",17 );
$App.title007n = localStorage.getItem("title007n");
debugScriptRun( 2631,"GetItem \"title008n\" [title008n]",18 );
$App.title008n = localStorage.getItem("title008n");
debugScriptRun( 2631,"GetItem \"title009\" [title009]",20 );
$App.title009 = localStorage.getItem("title009");
debugScriptRun( 2631,"GetItem \"title010\" [title010]",21 );
$App.title010 = localStorage.getItem("title010");
debugScriptRun( 2631,"GetItem \"title011\" [title011]",22 );
$App.title011 = localStorage.getItem("title011");
debugScriptRun( 2631,"GetItem \"title012\" [title012]",23 );
$App.title012 = localStorage.getItem("title012");
debugScriptRun( 2631,"GetItem \"title009n\" [title009n]",25 );
$App.title009n = localStorage.getItem("title009n");
debugScriptRun( 2631,"GetItem \"title010n\" [title010n]",26 );
$App.title010n = localStorage.getItem("title010n");
debugScriptRun( 2631,"GetItem \"title011n\" [title011n]",27 );
$App.title011n = localStorage.getItem("title011n");
debugScriptRun( 2631,"GetItem \"title012n\" [title012n]",28 );
$App.title012n = localStorage.getItem("title012n");
debugScriptRun( 2631,"GetItem \"title013\" [title005]",30 );
$App.title005 = localStorage.getItem("title013");
debugScriptRun( 2631,"GetItem \"title014\" [title006]",31 );
$App.title006 = localStorage.getItem("title014");
debugScriptRun( 2631,"GetItem \"title015\" [title007]",32 );
$App.title007 = localStorage.getItem("title015");
debugScriptRun( 2631,"GetItem \"title016\" [title008]",33 );
$App.title008 = localStorage.getItem("title016");
debugScriptRun( 2631,"GetItem \"title013n\" [title013n]",35 );
$App.title013n = localStorage.getItem("title013n");
debugScriptRun( 2631,"GetItem \"title014n\" [title014n]",36 );
$App.title014n = localStorage.getItem("title014n");
debugScriptRun( 2631,"GetItem \"title015n\" [title015n]",37 );
$App.title015n = localStorage.getItem("title015n");
debugScriptRun( 2631,"GetItem \"title016n\" [title016n]",38 );
$App.title016n = localStorage.getItem("title016n");
debugScriptEnd( 2631 );};
...
$App.NAB.PageID = "Home";
$scope.TextInput106_change = function() {debugScriptBegin( 2632,"TextInput106","change",1 );
debugScriptRun( 2632,"SetItem \"main001n\" [main001n]",0 );
localStorage.setItem("main001n",$App.main001n);
debugScriptEnd( 2632 );};
$scope.TextInput122_change = function() {debugScriptBegin( 2633,"TextInput122","change",1 );
debugScriptRun( 2633,"SetItem \"main002n\" [main002n]",0 );
localStorage.setItem("main002n",$App.main002n);
debugScriptEnd( 2633 );};
$scope.PushButton66_click = function() {debugScriptBegin( 2634,"PushButton66","click",1 );
debugScriptRun( 2634,"ReloadApp",0 );
window.document.location.reload();
debugScriptEnd( 2634 );};
$scope.TextInput69_change = function() {debugScriptBegin( 2635,"TextInput69","change",1 );
debugScriptRun( 2635,"SetItem \"main003n\" [main003n]",0 );
localStorage.setItem("main003n",$App.main003n);
debugScriptEnd( 2635 );};
$scope.TextInput70_change = function() {debugScriptBegin( 2636,"TextInput70","change",1 );
debugScriptRun( 2636,"SetItem \"main004n\" [main004n]",0 );
...
$scope.PushButton1_click = function() {debugScriptBegin( 2637,"PushButton1","click",1 );
debugScriptRun( 2637,"OpenURL \"[title001]\"",0 );
window.open($App.title001, "_blank");
debugScriptEnd( 2637 );};
$scope.PushButton3_click = function() {debugScriptBegin( 2638,"PushButton3","click",1 );
debugScriptRun( 2638,"OpenURL \"[title002]\"",0 );
window.open($App.title002, "_blank");
debugScriptEnd( 2638 );};
$scope.PushButton4_click = function() {debugScriptBegin( 2639,"PushButton4","click",1 );
debugScriptRun( 2639,"OpenURL \"[title003]\"",0 );
window.open($App.title003, "_blank");
debugScriptEnd( 2639 );};
$scope.PushButton5_click = function() {debugScriptBegin( 2640,"PushButton5","click",1 );
debugScriptRun( 2640,"OpenURL \"[title004]\"",0 );
window.open($App.title004, "_blank");
debugScriptEnd( 2640 );};
$scope.TextInput5_change = function() {debugScriptBegin( 2641,"TextInput5","change",1 );
debugScriptRun( 2641,"SetItem \"title001\" [title001]",0 );
localStorage.setItem("title001",$App.title001);
debugScriptEnd( 2641 );};
$scope.TextInput10_change = function() {debugScriptBegin( 2642,"TextInput10","change",1 );
debugScriptRun( 2642,"SetItem \"title001n\" [title001n]",0 );
localStorage.setItem("title001n",$App.title001n);
debugScriptEnd( 2642 );};
$scope.TextInput6_change = function() {debugScriptBegin( 2643,"TextInput6","change",1 );
debugScriptRun( 2643,"SetItem \"title002\" [title002]",0 );
localStorage.setItem("title002",$App.title002);
debugScriptEnd( 2643 );};
$scope.TextInput7_change = function() {debugScriptBegin( 2644,"TextInput7","change",1 );
debugScriptRun( 2644,"SetItem \"title002n\" [title002n]",0 );
localStorage.setItem("title002n",$App.title002n);
debugScriptEnd( 2644 );};
$scope.TextInput8_change = function() {debugScriptBegin( 2645,"TextInput8","change",1 );
debugScriptRun( 2645,"SetItem \"title003\" [title003]",0 );
localStorage.setItem("title003",$App.title003);
debugScriptEnd( 2645 );};
$scope.TextInput9_change = function() {debugScriptBegin( 2646,"TextInput9","change",1 );
debugScriptRun( 2646,"SetItem \"title003n\" [title003n]",0 );
localStorage.setItem("title003n",$App.title003n);
debugScriptEnd( 2646 );};
$scope.TextInput11_change = function() {debugScriptBegin( 2647,"TextInput11","change",1 );
debugScriptRun( 2647,"SetItem \"title004\" [title004]",0 );
localStorage.setItem("title004",$App.title004);
debugScriptEnd( 2647 );};
$scope.TextInput12_change = function() {debugScriptBegin( 2648,"TextInput12","change",1 );
debugScriptRun( 2648,"SetItem \"title004n\" [title004n]",0 );
localStorage.setItem("title004n",$App.title004n);
debugScriptEnd( 2648 );};
$scope.PushButton6_click = function() {debugScriptBegin( 2649,"PushButton6","click",1 );
debugScriptRun( 2649,"OpenURL \"[title005]\"",0 );
window.open($App.title005, "_blank");
debugScriptEnd( 2649 );};
$scope.PushButton7_click = function() {debugScriptBegin( 2650,"PushButton7","click",1 );
debugScriptRun( 2650,"OpenURL \"[title006]\"",0 );
window.open($App.title006, "_blank");
debugScriptEnd( 2650 );};
$scope.PushButton8_click = function() {debugScriptBegin( 2651,"PushButton8","click",1 );
debugScriptRun( 2651,"OpenURL \"[title007]\"",0 );
window.open($App.title007, "_blank");
debugScriptEnd( 2651 );};
$scope.PushButton9_click = function() {debugScriptBegin( 2652,"PushButton9","click",1 );
debugScriptRun( 2652,"OpenURL \"[title008]\"",0 );
window.open($App.title008, "_blank");
debugScriptEnd( 2652 );};
$scope.TextInput13_change = function() {debugScriptBegin( 2653,"TextInput13","change",1 );
debugScriptRun( 2653,"SetItem \"title005\" [title005]",0 );
localStorage.setItem("title005",$App.title005);
debugScriptEnd( 2653 );};
$scope.TextInput14_change = function() {debugScriptBegin( 2654,"TextInput14","change",1 );
debugScriptRun( 2654,"SetItem \"title005n\" [title005n]",0 );
localStorage.setItem("title005n",$App.title005n);
debugScriptEnd( 2654 );};
$scope.TextInput15_change = function() {debugScriptBegin( 2655,"TextInput15","change",1 );
debugScriptRun( 2655,"SetItem \"title006\" [title006]",0 );
localStorage.setItem("title006",$App.title006);
debugScriptEnd( 2655 );};
$scope.TextInput16_change = function() {debugScriptBegin( 2656,"TextInput16","change",1 );
debugScriptRun( 2656,"SetItem \"title006n\" [title006n]",0 );
localStorage.setItem("title006n",$App.title006n);
debugScriptEnd( 2656 );};
$scope.TextInput17_change = function() {debugScriptBegin( 2657,"TextInput17","change",1 );
debugScriptRun( 2657,"SetItem \"title007\" [title007]",0 );
localStorage.setItem("title007",$App.title007);
debugScriptEnd( 2657 );};
$scope.TextInput18_change = function() {debugScriptBegin( 2658,"TextInput18","change",1 );
debugScriptRun( 2658,"SetItem \"title007n\" [title007n]",0 );
localStorage.setItem("title007n",$App.title007n);
debugScriptEnd( 2658 );};
$scope.TextInput19_change = function() {debugScriptBegin( 2659,"TextInput19","change",1 );
debugScriptRun( 2659,"SetItem \"title008\" [title008]",0 );
localStorage.setItem("title008",$App.title008);
debugScriptEnd( 2659 );};
$scope.TextInput20_change = function() {debugScriptBegin( 2660,"TextInput20","change",1 );
debugScriptRun( 2660,"SetItem \"title008n\" [title008n]",0 );
localStorage.setItem("title008n",$App.title008n);
debugScriptEnd( 2660 );};
$scope.TextInput21_change = function() {debugScriptBegin( 2661,"TextInput21","change",1 );
debugScriptRun( 2661,"SetItem \"title009\" [title009]",0 );
localStorage.setItem("title009",$App.title009);
debugScriptEnd( 2661 );};
$scope.TextInput22_change = function() {debugScriptBegin( 2662,"TextInput22","change",1 );
debugScriptRun( 2662,"SetItem \"title009n\" [title009n]",0 );
localStorage.setItem("title009n",$App.title009n);
debugScriptEnd( 2662 );};
$scope.TextInput23_change = function() {debugScriptBegin( 2663,"TextInput23","change",1 );
debugScriptRun( 2663,"SetItem \"title010\" [title010]",0 );
localStorage.setItem("title010",$App.title010);
debugScriptEnd( 2663 );};
$scope.TextInput24_change = function() {debugScriptBegin( 2664,"TextInput24","change",1 );
debugScriptRun( 2664,"SetItem \"title010n\" [title010n]",0 );
localStorage.setItem("title010n",$App.title010n);
debugScriptEnd( 2664 );};
$scope.TextInput25_change = function() {debugScriptBegin( 2665,"TextInput25","change",1 );
debugScriptRun( 2665,"SetItem \"title011\" [title011]",0 );
localStorage.setItem("title011",$App.title011);
debugScriptEnd( 2665 );};
$scope.TextInput26_change = function() {debugScriptBegin( 2666,"TextInput26","change",1 );
debugScriptRun( 2666,"SetItem \"title011n\" [title011n]",0 );
localStorage.setItem("title011n",$App.title011n);
debugScriptEnd( 2666 );};
$scope.TextInput27_change = function() {debugScriptBegin( 2667,"TextInput27","change",1 );
debugScriptRun( 2667,"SetItem \"title012\" [title004]",0 );
localStorage.setItem("title012",$App.title004);
debugScriptEnd( 2667 );};
$scope.TextInput28_change = function() {debugScriptBegin( 2668,"TextInput28","change",1 );
debugScriptRun( 2668,"SetItem \"title012n\" [title012n]",0 );
localStorage.setItem("title012n",$App.title012n);
debugScriptEnd( 2668 );};
$scope.TextInput29_change = function() {debugScriptBegin( 2669,"TextInput29","change",1 );
debugScriptRun( 2669,"SetItem \"title013\" [title013]",0 );
localStorage.setItem("title013",$App.title013);
debugScriptEnd( 2669 );};
$scope.TextInput30_change = function() {debugScriptBegin( 2670,"TextInput30","change",1 );
debugScriptRun( 2670,"SetItem \"title013n\" [title013n]",0 );
localStorage.setItem("title013n",$App.title013n);
debugScriptEnd( 2670 );};
$scope.TextInput31_change = function() {debugScriptBegin( 2671,"TextInput31","change",1 );
debugScriptRun( 2671,"SetItem \"title014\" [title014]",0 );
localStorage.setItem("title014",$App.title014);
debugScriptEnd( 2671 );};
$scope.TextInput32_change = function() {debugScriptBegin( 2672,"TextInput32","change",1 );
debugScriptRun( 2672,"SetItem \"title014n\" [title014n]",0 );
localStorage.setItem("title014n",$App.title014n);
debugScriptEnd( 2672 );};
$scope.TextInput33_change = function() {debugScriptBegin( 2673,"TextInput33","change",1 );
debugScriptRun( 2673,"SetItem \"title015\" [title015]",0 );
localStorage.setItem("title015",$App.title015);
debugScriptEnd( 2673 );};
$scope.TextInput34_change = function() {debugScriptBegin( 2674,"TextInput34","change",1 );
debugScriptRun( 2674,"SetItem \"title015n\" [title015n]",0 );
localStorage.setItem("title015n",$App.title015n);
debugScriptEnd( 2674 );};
$scope.TextInput35_change = function() {debugScriptBegin( 2675,"TextInput35","change",1 );
debugScriptRun( 2675,"SetItem \"title016\" [title016]",0 );
localStorage.setItem("title016",$App.title016);
debugScriptEnd( 2675 );};
$scope.TextInput36_change = function() {debugScriptBegin( 2676,"TextInput36","change",1 );
debugScriptRun( 2676,"SetItem \"title016n\" [title016n]",0 );
localStorage.setItem("title016n",$App.title016n);
debugScriptEnd( 2676 );};
$scope.PushButton10_click = function() {debugScriptBegin( 2677,"PushButton10","click",1 );
debugScriptRun( 2677,"OpenURL \"[title009]\"",0 );
window.open($App.title009, "_blank");
debugScriptEnd( 2677 );};
$scope.PushButton11_click = function() {debugScriptBegin( 2678,"PushButton11","click",1 );
debugScriptRun( 2678,"OpenURL \"[title010]\"",0 );
window.open($App.title010, "_blank");
debugScriptEnd( 2678 );};
$scope.PushButton12_click = function() {debugScriptBegin( 2679,"PushButton12","click",1 );
debugScriptRun( 2679,"OpenURL \"[title011]\"",0 );
window.open($App.title011, "_blank");
debugScriptEnd( 2679 );};
$scope.PushButton13_click = function() {debugScriptBegin( 2680,"PushButton13","click",1 );
debugScriptRun( 2680,"OpenURL \"[title012]\"",0 );
window.open($App.title012, "_blank");
debugScriptEnd( 2680 );};
$scope.PushButton14_click = function() {debugScriptBegin( 2681,"PushButton14","click",1 );
debugScriptRun( 2681,"OpenURL \"[title013]\"",0 );
window.open($App.title013, "_blank");
debugScriptEnd( 2681 );};
$scope.PushButton15_click = function() {debugScriptBegin( 2682,"PushButton15","click",1 );
debugScriptRun( 2682,"OpenURL \"[title014]\"",0 );
window.open($App.title014, "_blank");
debugScriptEnd( 2682 );};
$scope.PushButton16_click = function() {debugScriptBegin( 2683,"PushButton16","click",1 );
debugScriptRun( 2683,"OpenURL \"[title015]\"",0 );
window.open($App.title015, "_blank");
debugScriptEnd( 2683 );};
$scope.PushButton17_click = function() {debugScriptBegin( 2684,"PushButton17","click",1 );
debugScriptRun( 2684,"OpenURL \"[title016]\"",0 );
window.open($App.title016, "_blank");
debugScriptEnd( 2684 );};
$scope.PushButton34_click = function() {debugScriptBegin( 2685,"PushButton34","click",1 );
debugScriptRun( 2685,"ReloadApp",0 );
window.document.location.reload();
debugScriptEnd( 2685 );};
$scope.PushButton36_click = function() {debugScriptBegin( 2686,"PushButton36","click",1 );
debugScriptRun( 2686,"GotoPage \"Home\"",0 );
$scope.GotoPage( "Home" );
debugScriptEnd( 2686 );};
});
NeoApp.controller("Workstuff_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 3;
$App.NAB.PageID = "Workstuff";
$scope.PushButton72_click = function() {debugScriptBegin( 2687,"PushButton72","click",1 );
debugScriptRun( 2687,"ReloadApp",0 );
window.document.location.reload();
debugScriptEnd( 2687 );};
$scope.PushButton73_click = function() {debugScriptBegin( 2688,"PushButton73","click",1 );
debugScriptRun( 2688,"GotoPage \"Home\"",0 );
$scope.GotoPage( "Home" );
debugScriptEnd( 2688 );};
$scope.TextInput71_change = function() {debugScriptBegin( 2689,"TextInput71","change",1 );
debugScriptRun( 2689,"SetItem \"1title001\" [1title001]",0 );
localStorage.setItem("1title001",$App.1title001);
debugScriptEnd( 2689 );};
$scope.TextInput72_change = function() {debugScriptBegin( 2690,"TextInput72","change",1 );
debugScriptRun( 2690,"SetItem \"1title001n\" [1title001n]",0 );
localStorage.setItem("1title001n",$App.1title001n);
debugScriptEnd( 2690 );};
$scope.TextInput73_change = function() {debugScriptBegin( 2691,"TextInput73","change",1 );
debugScriptRun( 2691,"SetItem \"1title002\" [1title002]",0 );
localStorage.setItem("1title002",$App.1title002);
debugScriptEnd( 2691 );};
$scope.TextInput74_change = function() {debugScriptBegin( 2692,"TextInput74","change",1 );
debugScriptRun( 2692,"SetItem \"1title002n\" [1title002n]",0 );
localStorage.setItem("1title002n",$App.1title002n);
debugScriptEnd( 2692 );};
$scope.TextInput75_change = function() {debugScriptBegin( 2693,"TextInput75","change",1 );
debugScriptRun( 2693,"SetItem \"1title003\" [1title003]",0 );
localStorage.setItem("1title003",$App.1title003);
debugScriptEnd( 2693 );};
$scope.TextInput76_change = function() {debugScriptBegin( 2694,"TextInput76","change",1 );
debugScriptRun( 2694,"SetItem \"1title003n\" [1title003n]",0 );
localStorage.setItem("1title003n",$App.1title003n);
debugScriptEnd( 2694 );};
$scope.TextInput77_change = function() {debugScriptBegin( 2695,"TextInput77","change",1 );
debugScriptRun( 2695,"SetItem \"1title004\" [1title004]",0 );
localStorage.setItem("1title004",$App.1title004);
debugScriptEnd( 2695 );};
$scope.TextInput78_change = function() {debugScriptBegin( 2696,"TextInput78","change",1 );
debugScriptRun( 2696,"SetItem \"1title004n\" [1title004n]",0 );
localStorage.setItem("1title004n",$App.1title004n);
debugScriptEnd( 2696 );};
$scope.TextInput79_change = function() {debugScriptBegin( 2697,"TextInput79","change",1 );
debugScriptRun( 2697,"SetItem \"1title005\" [1title005]",0 );
localStorage.setItem("1title005",$App.1title005);
debugScriptEnd( 2697 );};
$scope.TextInput80_change = function() {debugScriptBegin( 2698,"TextInput80","change",1 );
debugScriptRun( 2698,"SetItem \"1title005n\" [1title005n]",0 );
localStorage.setItem("1title005n",$App.1title005n);
debugScriptEnd( 2698 );};
$scope.TextInput81_change = function() {debugScriptBegin( 2699,"TextInput81","change",1 );
debugScriptRun( 2699,"SetItem \"1title006\" [1title006]",0 );
localStorage.setItem("1title006",$App.1title006);
debugScriptEnd( 2699 );};
$scope.TextInput82_change = function() {debugScriptBegin( 2700,"TextInput82","change",1 );
debugScriptRun( 2700,"SetItem \"1title006n\" [1title006n]",0 );
localStorage.setItem("1title006n",$App.1title006n);
debugScriptEnd( 2700 );};
$scope.TextInput83_change = function() {debugScriptBegin( 2701,"TextInput83","change",1 );
debugScriptRun( 2701,"SetItem \"1title007\" [1title007]",0 );
localStorage.setItem("1title007",$App.1title007);
debugScriptEnd( 2701 );};
$scope.TextInput84_change = function() {debugScriptBegin( 2702,"TextInput84","change",1 );
debugScriptRun( 2702,"SetItem \"1title007n\" [1title007n]",0 );
localStorage.setItem("1title007n",$App.1title007n);
debugScriptEnd( 2702 );};
$scope.TextInput85_change = function() {debugScriptBegin( 2703,"TextInput85","change",1 );
debugScriptRun( 2703,"SetItem \"1title008\" [1title008]",0 );
localStorage.setItem("1title008",$App.1title008);
debugScriptEnd( 2703 );};
$scope.TextInput86_change = function() {debugScriptBegin( 2704,"TextInput86","change",1 );
debugScriptRun( 2704,"SetItem \"1title008n\" [1title008n]",0 );
localStorage.setItem("1title008n",$App.1title008n);
debugScriptEnd( 2704 );};
$scope.TextInput87_change = function() {debugScriptBegin( 2705,"TextInput87","change",1 );
debugScriptRun( 2705,"SetItem \"1title009\" [1title009]",0 );
localStorage.setItem("1title009",$App.1title009);
debugScriptEnd( 2705 );};
$scope.TextInput88_change = function() {debugScriptBegin( 2706,"TextInput88","change",1 );
debugScriptRun( 2706,"SetItem \"1title009n\" [1title009n]",0 );
localStorage.setItem("1title009n",$App.1title009n);
debugScriptEnd( 2706 );};
$scope.TextInput89_change = function() {debugScriptBegin( 2707,"TextInput89","change",1 );
debugScriptRun( 2707,"SetItem \"1title010\" [1title010]",0 );
localStorage.setItem("1title010",$App.1title010);
debugScriptEnd( 2707 );};
$scope.TextInput90_change = function() {debugScriptBegin( 2708,"TextInput90","change",1 );
debugScriptRun( 2708,"SetItem \"1title010n\" [1title010n]",0 );
localStorage.setItem("1title010n",$App.1title010n);
debugScriptEnd( 2708 );};
$scope.TextInput91_change = function() {debugScriptBegin( 2709,"TextInput91","change",1 );
debugScriptRun( 2709,"SetItem \"1title011\" [1title011]",0 );
localStorage.setItem("1title011",$App.1title011);
debugScriptEnd( 2709 );};
$scope.TextInput92_change = function() {debugScriptBegin( 2710,"TextInput92","change",1 );
debugScriptRun( 2710,"SetItem \"1title011n\" [1title011n]",0 );
localStorage.setItem("1title011n",$App.1title011n);
debugScriptEnd( 2710 );};
$scope.TextInput93_change = function() {debugScriptBegin( 2711,"TextInput93","change",1 );
debugScriptRun( 2711,"SetItem \"1title012\" [1title004]",0 );
localStorage.setItem("1title012",$App.1title004);
debugScriptEnd( 2711 );};
$scope.TextInput94_change = function() {debugScriptBegin( 2712,"TextInput94","change",1 );
debugScriptRun( 2712,"SetItem \"1title012n\" [1title012n]",0 );
localStorage.setItem("1title012n",$App.1title012n);
debugScriptEnd( 2712 );};
$scope.TextInput95_change = function() {debugScriptBegin( 2713,"TextInput95","change",1 );
debugScriptRun( 2713,"SetItem \"1title013\" [1title013]",0 );
localStorage.setItem("1title013",$App.1title013);
debugScriptEnd( 2713 );};
$scope.TextInput96_change = function() {debugScriptBegin( 2714,"TextInput96","change",1 );
debugScriptRun( 2714,"SetItem \"1title013n\" [1title013n]",0 );
localStorage.setItem("1title013n",$App.1title013n);
debugScriptEnd( 2714 );};
$scope.TextInput97_change = function() {debugScriptBegin( 2715,"TextInput97","change",1 );
debugScriptRun( 2715,"SetItem \"1title014\" [1title014]",0 );
localStorage.setItem("1title014",$App.1title014);
debugScriptEnd( 2715 );};
$scope.TextInput98_change = function() {debugScriptBegin( 2716,"TextInput98","change",1 );
debugScriptRun( 2716,"SetItem \"1title014n\" [1title014n]",0 );
localStorage.setItem("1title014n",$App.1title014n);
debugScriptEnd( 2716 );};
$scope.TextInput99_change = function() {debugScriptBegin( 2717,"TextInput99","change",1 );
debugScriptRun( 2717,"SetItem \"1title015\" [1title015]",0 );
localStorage.setItem("1title015",$App.1title015);
debugScriptEnd( 2717 );};
$scope.TextInput100_change = function() {debugScriptBegin( 2718,"TextInput100","change",1 );
debugScriptRun( 2718,"SetItem \"1title015n\" [1title015n]",0 );
localStorage.setItem("1title015n",$App.1title015n);
debugScriptEnd( 2718 );};
$scope.TextInput101_change = function() {debugScriptBegin( 2719,"TextInput101","change",1 );
debugScriptRun( 2719,"SetItem \"1title016\" [1title016]",0 );
localStorage.setItem("1title016",$App.1title016);
debugScriptEnd( 2719 );};
$scope.TextInput102_change = function() {debugScriptBegin( 2720,"TextInput102","change",1 );
debugScriptRun( 2720,"SetItem \"1title016n\" [1title016n]",0 );
localStorage.setItem("1title016n",$App.1title016n);
debugScriptEnd( 2720 );};
$scope.PushButton37_click = function() {debugScriptBegin( 2721,"PushButton37","click",1 );
debugScriptRun( 2721,"OpenURL \"[1title001]\"",0 );
window.open($App.1title001, "_blank");
debugScriptEnd( 2721 );};
$scope.PushButton38_click = function() {debugScriptBegin( 2722,"PushButton38","click",1 );
debugScriptRun( 2722,"OpenURL \"[1title002]\"",0 );
window.open($App.1title002, "_blank");
debugScriptEnd( 2722 );};
$scope.PushButton39_click = function() {debugScriptBegin( 2723,"PushButton39","click",1 );
debugScriptRun( 2723,"OpenURL \"[1title003]\"",0 );
window.open($App.1title003, "_blank");
debugScriptEnd( 2723 );};
$scope.PushButton40_click = function() {debugScriptBegin( 2724,"PushButton40","click",1 );
debugScriptRun( 2724,"OpenURL \"[1title004]\"",0 );
window.open($App.1title004, "_blank");
debugScriptEnd( 2724 );};
$scope.PushButton41_click = function() {debugScriptBegin( 2725,"PushButton41","click",1 );
debugScriptRun( 2725,"OpenURL \"[1title005]\"",0 );
window.open($App.1title005, "_blank");
debugScriptEnd( 2725 );};
$scope.PushButton44_click = function() {debugScriptBegin( 2726,"PushButton44","click",1 );
debugScriptRun( 2726,"OpenURL \"[1title006]\"",0 );
window.open($App.1title006, "_blank");
debugScriptEnd( 2726 );};
$scope.PushButton45_click = function() {debugScriptBegin( 2727,"PushButton45","click",1 );
debugScriptRun( 2727,"OpenURL \"[1title007]\"",0 );
window.open($App.1title007, "_blank");
debugScriptEnd( 2727 );};
$scope.PushButton46_click = function() {debugScriptBegin( 2728,"PushButton46","click",1 );
debugScriptRun( 2728,"OpenURL \"[1title008]\"",0 );
window.open($App.1title008, "_blank");
debugScriptEnd( 2728 );};
$scope.PushButton47_click = function() {debugScriptBegin( 2729,"PushButton47","click",1 );
debugScriptRun( 2729,"OpenURL \"[1title009]\"",0 );
window.open($App.1title009, "_blank");
debugScriptEnd( 2729 );};
$scope.PushButton48_click = function() {debugScriptBegin( 2730,"PushButton48","click",1 );
debugScriptRun( 2730,"OpenURL \"[1title010]\"",0 );
window.open($App.1title010, "_blank");
debugScriptEnd( 2730 );};
$scope.PushButton49_click = function() {debugScriptBegin( 2731,"PushButton49","click",1 );
debugScriptRun( 2731,"OpenURL \"[1title011]\"",0 );
window.open($App.1title011, "_blank");
debugScriptEnd( 2731 );};
$scope.PushButton50_click = function() {debugScriptBegin( 2732,"PushButton50","click",1 );
debugScriptRun( 2732,"OpenURL \"[1title012]\"",0 );
window.open($App.1title012, "_blank");
debugScriptEnd( 2732 );};
$scope.PushButton51_click = function() {debugScriptBegin( 2733,"PushButton51","click",1 );
debugScriptRun( 2733,"OpenURL \"[1title013]\"",0 );
window.open($App.1title013, "_blank");
debugScriptEnd( 2733 );};
$scope.PushButton52_click = function() {debugScriptBegin( 2734,"PushButton52","click",1 );
debugScriptRun( 2734,"OpenURL \"[1title014]\"",0 );
window.open($App.1title014, "_blank");
debugScriptEnd( 2734 );};
$scope.PushButton53_click = function() {debugScriptBegin( 2735,"PushButton53","click",1 );
debugScriptRun( 2735,"OpenURL \"[1title015]\"",0 );
window.open($App.1title015, "_blank");
debugScriptEnd( 2735 );};
$scope.PushButton54_click = function() {debugScriptBegin( 2736,"PushButton54","click",1 );
debugScriptRun( 2736,"OpenURL \"[1title016]\"",0 );
window.open($App.1title016, "_blank");
debugScriptEnd( 2736 );};
});
...
$scope.TextArea1_change = function() {debugScriptBegin( 2737,"TextArea1","change",1 );
debugScriptRun( 2737,"SetItem \"FNM001\" [FNM001]",0 );
localStorage.setItem("FNM001",$App.FNM001);
debugScriptEnd( 2737 );};
$scope.Pager2_prevclick = function() {debugScriptBegin( 2738,"Pager2","prevclick",1 );
debugScriptRun( 2738,"GotoPrevPage",0 );
$scope.GotoPrevPage();
debugScriptEnd( 2738 );};
$scope.Pager2_nextclick = function() {debugScriptBegin( 2739,"Pager2","nextclick",1 );
debugScriptRun( 2739,"GotoNextPage",0 );
$scope.GotoNextPage();
debugScriptEnd( 2739 );};
});
...
$scope.Pager1_prevclick = function() {debugScriptBegin( 2740,"Pager1","prevclick",1 );
debugScriptRun( 2740,"GotoPrevPage",0 );
$scope.GotoPrevPage();
debugScriptEnd( 2740 );};
$scope.Pager1_nextclick = function() {debugScriptBegin( 2741,"Pager1","nextclick",1 );
debugScriptRun( 2741,"GotoNextPage",0 );
$scope.GotoNextPage();
debugScriptEnd( 2741 );};
});
