...
$scope.Temphome_pageenter = function() {$App.VERSION = "v3.095";
...
$scope.PushButton154_click = function() {window.open($App.Tititle002, "_blank");};
...
$scope.TextInput226_change = function() {localStorage.setItem("TItitle002n",$App.Tititle002n);};
$scope.TextInput227_change = function() {localStorage.setItem("TItitle003",$App.Tititle003);};
$scope.TextInput228_change = function() {localStorage.setItem("TItitle003n",$App.Tititle003n);};
$scope.TextInput229_change = function() {localStorage.setItem("TItitle004",$App.Tititle004);};
$scope.TextInput230_change = function() {localStorage.setItem("TItitle004n",$App.Tititle004n);};
...
$scope.TextInput231_change = function() {localStorage.setItem("TItitle005",$App.Tititle005);};
$scope.TextInput232_change = function() {localStorage.setItem("TItitle005n",$App.Tititle005n);};
$scope.TextInput233_change = function() {localStorage.setItem("TItitle006",$App.Tititle006);};
$scope.TextInput234_change = function() {localStorage.setItem("TItitle006n",$App.Tititle006n);};
$scope.TextInput235_change = function() {localStorage.setItem("TItitle007",$App.Tititle007);};
$scope.TextInput236_change = function() {localStorage.setItem("TItitle007n",$App.Tititle007n);};
...
$scope.TextInput243_change = function() {localStorage.setItem("TItitle011",$App.Tititle011);};
$scope.TextInput244_change = function() {localStorage.setItem("TItitle011n",$App.Tititle011n);};
$scope.TextInput245_change = function() {localStorage.setItem("TItitle012",$App.Tititle012);};
$scope.TextInput246_change = function() {localStorage.setItem("TItitle012n",$App.Tititle012n);};
$scope.TextInput247_change = function() {localStorage.setItem("title013",$App.title013);};
$scope.TextInput248_change = function() {localStorage.setItem("TItitle013n",$App.TItitle013n);};
$scope.TextInput249_change = function() {localStorage.setItem("TItitle014",$App.Tititle014);};
$scope.TextInput250_change = function() {localStorage.setItem("TItitle014n",$App.TItitle014n);};
$scope.TextInput251_change = function() {localStorage.setItem("TItitle015",$App.Tititle015);};
$scope.TextInput252_change = function() {localStorage.setItem("title015n",$App.title015n);};
...
$scope.PushButton186_click = function() {window.open($App.Tititle014, "_blank");};
$scope.PushButton187_click = function() {window.open($App.Tititle015, "_blank");};
