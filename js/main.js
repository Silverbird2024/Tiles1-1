...
$scope.Temphome_pageenter = function() {$App.VERSION = "v3.0991";
...
$scope.TextInput243_change = function() {localStorage.setItem("Read1",$App.Read1);};
$scope.TextInput244_change = function() {localStorage.setItem("Read2",$App.Read2);};
