...
$scope.TextInput243_change = function() {localStorage.setItem("ToDon",$App.ToDon);};
$scope.PushButton206_click = function() {window.open($App.ToDon, "_blank");};
$scope.TextInput244_change = function() {localStorage.setItem("ToDo",$App.ToDo);};
});
